namespace IncidentReportingSystem.Application.Abstractions.Persistence
{
    ...
    public interface IIdempotencyStore
    {
        ...
        /// </summary>
        Task<TResponse?> TryGetAsync<TPayload, TResponse>(string key, TPayload payload, CancellationToken cancellationToken);
        ...
        /// </summary>
        Task<TResponse> PutIfAbsentAsync<TPayload, TResponse>(string key, TPayload payload, TResponse response, TimeSpan ttl, CancellationToken cancellationToken);
    }
}